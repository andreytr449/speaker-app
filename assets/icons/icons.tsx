...
export function MistakeIcon({fill, ...props}: { fill?: string, props?: any }) {
    return (
        <Svg
            width={25}
            height={24}
...
export const AddFriendIcon = ({isDark, ...props}: {
    isDark?: boolean,
    props?: any
}) => {
    return (
...
export const SettingsIcon = ({isDark, ...props}: {
    isDark?: boolean,
    props?: any
}) => {
    return (
...
export const CertificateIcon = ({isDark, ...props}: {
    isDark?: boolean,
    props?: any
}) => {
    return (
...
export const CalendarIcon = ({isDark, ...props}: {
    isDark?: boolean,
    props?: any
}) => {
    return (
